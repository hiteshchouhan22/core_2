...
const Connected: FC = () => {
  ...
  const fetchNfts = async () => {
    ...
    const cm = await metaplex.candyMachinesV2().findByAddress({address: new PublicKey("Dzzi9AfyFAXPL6KDRrcNFEDyq1i9uaGAhXhuCnmxnQEG")})
  ...
  return (
    <VStack spacing={20}>
      <Container>
        <VStack spacing={8}>
          ...
          <Text color="bodyText" fontSize="xl" textAlign="center">
            ...
            <Text as="b"> $PASH</Text> Use your <Text as="b"> $PASH</Text> to
            upgrade your PASH and receive perks within the community!
          </Text>
        </VStack>
      </Container>
      ...
      <Button
        ...
        >
          <HStack>
            <Text>{!isMinting ? 'mint pash' : 'wait a bit...'}</Text>
            <ArrowForwardIcon />
          </HStack>
      </Button>
